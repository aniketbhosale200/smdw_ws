...
def generate_launch_description():
    left_smdw_dir = get_package_share_directory("left_smdw")
    
    # Declare argument for model path
    model_arg = DeclareLaunchArgument(
        name="model",
        default_value=os.path.join(left_smdw_dir, "urdf", "left_smdw.urdf.xacro"),
    ...
    rviz_config_arg = DeclareLaunchArgument(
        name="rviz_config",
        default_value=os.path.join(left_smdw_dir, "rviz", "left_smdw_config.rviz"),
    ...
    world_arg = DeclareLaunchArgument(
        name="world",
        default_value=os.path.join(left_smdw_dir, "worlds", "empty.world"),
    ...
    gazebo_model_path = SetEnvironmentVariable(
        ...
        value=os.path.join(left_smdw_dir, "models")
    )
    ...
    spawn_entity_node = Node(
        ...
        output="screen",
        arguments=["-topic", "/robot_description", "-entity", "left_smdw"],
        parameters=[{"use_sim_time": LaunchConfiguration("use_sim_time")}]
    )
